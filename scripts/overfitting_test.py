...
from src.utils.reconstructions import get_reconstructions, show_reconstructions
from src.utils.plots import plot, loss_plot
...
def main():
    ...
    show_reconstructions(images, x_hats, PROJECT_ROOT / "src" / "results" / "overfitting_test")

    loss_plot(reconstruction_losses, kl_losses, train_losses, epochs)
